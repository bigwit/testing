package itmo.cs.testing.lab2.util;
...
public class Plotter {
     ...
     */
    public static void plot(String filename, Function expression, List<Interval> intervals) 
     ...
     * @throws UnsupportedEncodingException 
     */
    public static void plot(String filename, Function expression, double x0, double x1, double d) 
            throws FileNotFoundException, UnsupportedEncodingException {
        try (PrintWriter writer = new PrintWriter(filename, "UTF-8")) {
    ...
    private static void plot(PrintWriter writer, Function expression, Interval interval) {
